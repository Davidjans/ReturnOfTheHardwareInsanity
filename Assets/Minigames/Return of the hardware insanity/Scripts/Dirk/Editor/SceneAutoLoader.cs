// Borrowed from https://wiki.unity3d.com/index.php/SceneAutoLoader
// This should make sure that when you click Play on any scene it will save the current scene, open a master scene, and play that one.
